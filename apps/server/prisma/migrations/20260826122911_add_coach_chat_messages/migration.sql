...
-- AddForeignKey
ALTER TABLE "coach_chat_messages" ADD CONSTRAINT "coach_chat_messages_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
